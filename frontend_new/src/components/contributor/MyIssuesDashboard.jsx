        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className={`bg-[hsl(220,13%,12%)] hover:bg-[hsl(220,13%,18%)] text-white px-4 py-2 rounded-lg font-medium flex items-center gap-2 transition-all duration-300 active:scale-[0.98] border border-[hsl(220,13%,18%)] ${isGitHubSyncing ? 'opacity-70 cursor-not-allowed' : ''}`}
